...
const initialMessage: Message = {
  content:
    "Hello! I'm KOBE, your web3 developer assistant. How can I help you today?",
  sender: "ai",
};
...
export default function Chat() {
  ...
  const handleDeploy = async (network: "arbitrum") => {
    setIsDeploying(true);
    ...
    try {
      const response = await fetch(
        network === "arbitrum"
          ? "http://localhost:3001/api/deploy/arbitrum"
          : "http://localhost:3001/api/deploy/arbitrum",
        {
          method: "POST",
        }
      ...
      const errorMessage = {
        content: `Error deploying to ${network}: ${
  ...
  const activeMessages = chatHistory.find((chat) => chat.id === activeChat)
    ?.messages || [initialMessage];
    ...
    <div className="fixed inset-0 flex">
      ...
      <div className={`fixed left-0 w-64 h-full ${
        ...
        <button
          ...
          } text-white rounded-lg flex items-center justify-center transition duration-200 shadow-md`}
        >
      ...
      {/* Main chat area */}
      <div className={`fixed left-64 right-64 h-full flex flex-col ${
            ...
            >
              ...
              >
                {message.sender === "ai" &&
                  ...
                  message.content !== "Deploying on blockchain..." && (
                    <div className="mb-2">
                              ...
                              <div className="overflow-x-auto">
                                ...
                                >
                                  <button
                                    ...
                                    } px-3 py-1 rounded text-xs hover:bg-opacity-80 transition-colors duration-200`}
                                  >
                                  ...
                                  <code
                                    className={`${className} block mt-4 ${
                                      isDarkTheme
                                        ? "text-gray-300"
                                        : "text-gray-800"
                                    }`}
          ...
          >
            ...
            <button
              ...
              className={`${
                isDarkTheme
                  ? "bg-blue-600 hover:bg-blue-700"
                  : "bg-blue-500 hover:bg-blue-600"
              } text-white px-4 py-2 rounded-full transition duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                isLoading ? "opacity-50 cursor-not-allowed" : ""
              } font-sans font-semibold tracking-wide flex items-center`}
              disabled={isLoading}
            >
            ...
            <div className="relative">
              <button
                ...
                } text-white px-4 py-2 rounded-full transition duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-green-500 font-sans font-semibold tracking-wide flex items-center`}
              >
      ...
      <div className={`fixed right-0 w-64 h-full ${
        isDarkTheme ? "bg-gray-800" : "bg-white"
      } flex flex-col shadow-lg`}>
        <div className="p-4 text-2xl font-bold text-white-500 flex items-center">
          Backend Logs
